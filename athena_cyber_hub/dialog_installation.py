...
@Gtk.Template(resource_path='/org/athenaos/CyberHub/gtk/dialog-installation.ui')
class AthenaDialogInstallation(Adw.Window):
    __gtype_name__ = 'AthenaDialogInstallation'
