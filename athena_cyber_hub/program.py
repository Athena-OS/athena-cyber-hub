...
logger = logging.getLogger("Athena:Program")


@Gtk.Template(resource_path='/org/athenaos/CyberHub/gtk/program.ui')
class AthenaAchProgram(Adw.ActionRow):
    __gtype_name__ = "AthenaAchProgram"
    __gsignals__ = {
