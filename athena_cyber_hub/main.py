...
locale.bindtextdomain("athena-cyber-hub", locale_dir)
locale.textdomain("athena-cyber-hub")
gettext.bindtextdomain("athena-cyber-hub", locale_dir)
gettext.textdomain("athena-cyber-hub")
_ = gettext.gettext
...
class AthenaCyberHubApplication(Adw.Application):
    """The main application singleton class."""

    def __init__(self):
        super().__init__(application_id='org.athenaos.CyberHub',
    ...
    def on_about_action(self, widget, *args):
        ...
        about = Adw.AboutWindow(transient_for=self.props.active_window,
                                application_name=_('Athena OS Cyber Hub'),
                                application_icon='org.athenaos.CyberHub',
                                developer_name='Antonio Voza',
                                version='1.1.0',
                                copyright='Copyright © 2023 Antonio Voza and Contributors',
                                website='https://github.com/Athena-OS',
                                issue_url=('https://github.com/Athena-OS/athena-cyber-hub/issues'),
                                license_type=('gpl-3-0-only'))
        about.add_credit_section(
            _("Code by"),
            [
                "Antonio Voza https://github.com/D3vil0p3r",
